#Uses lookup table from http://www.cs.utsa.edu/~wagner/laws/FFM.html for logarithms and inverses.
#generator is x+1, irreducible polynomial is m(x): (8 4 3 1 0)
#problem 1
...
def tests():
	...
	e = generateExponentials()
	l = generateLogarithms()
	i = generateInverses()
